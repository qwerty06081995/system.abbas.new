...
class CreateRoadsTable extends Migration
{
    ...
    public function up()
    {
        Module::generate("Roads", 'roads', 'road_name', 'fa-automobile', [
            ["road_name", "Имя маршрута", "String", false, "", 0, 256, false],
            ["courier_name", "Курьер", "Dropdown", false, "", 0, 256, false, "@employees"],
        ]);
