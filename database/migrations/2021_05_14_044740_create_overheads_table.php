...
class CreateOverheadsTable extends Migration
{
    ...
    public function up()
    {
        Module::generate("Overheads", 'overheads', 'overhead_code', 'fa-book', [
            ["overhead_code", "Код", "String", true, "", 0, 256, false],
            ...
            ["type", "Тип отправления", "String", false, "", 0, 256, false],
            ["speed", "Скорость", "String", false, "", 0, 256, false],
            ["payment", "Оплата", "String", false, "", 0, 256, false],
            ["payment_type", "Способ оплаты", "String", false, "", 0, 256, false],
            ["comment", "Примечание", "Textarea", false, "", 0, 0, false],
            ["total_mass", "Общий вес", "Decimal", false, "", 0, 11, false],
            ["volume", "Объемный вес", "Decimal", false, "", 0, 11, false],
        ]);
    ...
    {
        if (Schema::hasTable('overheads')) {
            Schema::drop('overheads');
        }
    }
}
