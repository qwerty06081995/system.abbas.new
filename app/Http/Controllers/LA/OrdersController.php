...
class OrdersController extends Controller
{
	...
	public $view_col = 'overhead_id';
	public $listing_cols = ['id', 'order_code', 'from_name', 'from_company', 'from_city', 'from_address', 'to_name', 'to_company', 'to_city', 'to_address', 'to_phone', 'from_phone', 'date_s', 'date_e', 'type', 'speed', 'payment', 'payment_type', 'comment', 'status', 'courier_id', 'overhead_id'];
