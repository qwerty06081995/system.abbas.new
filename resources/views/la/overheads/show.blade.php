...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $overhead->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("Overheads", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/overheads/'.$overhead->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Overheads", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.overheads.destroy', $overhead->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/overheads') }}" data-toggle="tooltip" data-placement="right" title="Back to Overheads"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						@la_display($module, 'overhead_code')
						@la_display($module, 'from_name')
						@la_display($module, 'from_company')
						@la_display($module, 'from_city')
						@la_display($module, 'from_address')
						@la_display($module, 'to_name')
						@la_display($module, 'from_phone')
						@la_display($module, 'to_company')
						@la_display($module, 'to_city')
						@la_display($module, 'to_address')
						@la_display($module, 'to_phone')
						@la_display($module, 'date_s')
						@la_display($module, 'date_e')
						@la_display($module, 'type')
						@la_display($module, 'speed')
						@la_display($module, 'payment')
						@la_display($module, 'payment_type')
						@la_display($module, 'comment')
						@la_display($module, 'total_mass')
						@la_display($module, 'volume')
					</div>
				</div>
			</div>
		</div>
